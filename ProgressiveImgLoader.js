...
(function(def){
  ...
  def(['THREE'], function(THREE) {
    ...
    var proto = ProgressiveImgLoader.prototype = Object.create( THREE.EventDispatcher.prototype );
    ...
    typeof require === 'undefined'?
        ...
        function(deps, factory){
            this.ProgressiveImgLoader = factory(this.THREE);
        } :
        ((typeof exports === 'undefined')?
            //AMD
            function(deps, factory){
                define('ProgressiveImgLoader', deps, factory);
            } :
            //CommonJS
            function(deps, factory){
