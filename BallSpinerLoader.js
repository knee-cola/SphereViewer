/**
 * BallSpinerLoader.js <https://github.com/knee-cola/BallSpinerLoader.js>
...
(function(def){
  ...
  def(['THREE'], function(THREE) {
    ...
    var BallSpinerLoader = function(config) {
      config = config  || {};
      ...
      this.animationAmplitude = config.animationAmplitude || 80;
    ...
    typeof require === 'undefined'?
        ...
        function(deps, factory){
            this.BallSpinerLoader = factory(this.THREE);
        } :
        ((typeof exports === 'undefined')?
            //AMD
            function(deps, factory){
                define('BallSpinerLoader', deps, factory);
            } :
            //CommonJS
            function(deps, factory){
